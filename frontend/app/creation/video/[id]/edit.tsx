...
import { getVideos, updateVideo, updateVideoThumbnail } from '../../../../utils/mockApi';
...
export default function VideoEditScreen() {
  ...
  const loadVideo = async () => {
    try {
      ...
      if (foundVideo) {
        ...
        setThumbnailUri(foundVideo.thumbnail_url);
        setPrivacy(foundVideo.privacy || 'public');
  ...
  const handleSave = async () => {
    ...
    try {
      // サムネイルが変更されていれば更新
      if (thumbnailUri !== video?.thumbnail_url) {
        await updateVideoThumbnail(id as string, thumbnailUri);
      }
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.hint}>推奨: 1280x720 (16:9) • JPGまたはPNG • 2MB以下</Text>
        </View>

...
動画配信プラットフォームのバックエンドAPIを構築し、以下の目標を達成する:

- **スケーラブルな動画配信基盤**: 100万ユーザー、10万同時接続に対応
- **マルチコンテンツ対応**: 通常動画、ショート動画、ライブ配信、Netflix風コンテンツ
- **柔軟な収益化**: サブスクリプション（3プラン）、投げ銭、クリエイター収益分配
- **エンタープライズ品質**: API応答 < 200ms、動画開始 < 2秒、99.9% SLA
- **完全なテストカバレッジ**: 単体テスト80%以上、統合テスト全エンドポイント
...
| フェーズ | 期間 | 主要マイルストーン |
|---------|-----|------------------|
| Phase 1: Foundation | 2週間 | 認証、DB、CI/CD完成 |
| Phase 2: Content Management | 4週間 | 動画・ショートCRUD完成 |
| Phase 3: Monetization | 3週間 | サブスク・決済完成 |
| Phase 4: Advanced Features | 5週間 | ライブ、検索、推薦完成 |
| Phase 5: Production Readiness | 2週間 | 本番環境、負荷テスト完成 |
